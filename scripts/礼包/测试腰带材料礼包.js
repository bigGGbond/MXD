// 腰带材料数据 - 每个数组第一个元素是材料ID，后面材料数量
var 一阶腰带材料 = [4442300, 5, 8, 15, 31, 54]
var 二阶腰带材料 = [4500602, 4, 8, 13, 28, 49]
var 三阶腰带材料 = [4500603, 4, 7, 12, 26, 44]
var 四阶腰带材料 = [4500604, 3, 6, 11, 24, 40]
var 五阶腰带材料 = [4500605, 3, 6, 10, 21, 37]
var 六阶腰带材料 = [4500606, 3, 5, 9, 19, 33]
var 七阶腰带材料 = [4500607, 3, 5, 8, 18, 30]
var 八阶腰带材料 = [4500608, 2, 4, 8, 16, 28]
var 九阶腰带材料 = [4500609, 2, 4, 7, 15, 25]
var 十阶腰带材料 = [4500610, 2, 4, 6, 13, 23]
var 十一阶腰带材料 = [4500611, 2, 3, 6, 12, 21]
var 十二阶腰带材料 = [4500612, 2, 3, 5, 11, 19]
var 十三阶腰带材料 = [4500613, 1, 3, 5, 10, 17]


// 将所有腰带材料数据组织成一个数组
var 腰带材料列表 = [
    {name: "一阶腰带材料", data: 一阶腰带材料},
    {name: "二阶腰带材料", data: 二阶腰带材料},
    {name: "三阶腰带材料", data: 三阶腰带材料},
    {name: "四阶腰带材料", data: 四阶腰带材料},
    {name: "五阶腰带材料", data: 五阶腰带材料},
    {name: "六阶腰带材料", data: 六阶腰带材料},
    {name: "七阶腰带材料", data: 七阶腰带材料},
    {name: "八阶腰带材料", data: 八阶腰带材料},
    {name: "九阶腰带材料", data: 九阶腰带材料},
    {name: "十阶腰带材料", data: 十阶腰带材料},
    {name: "十一阶腰带材料", data: 十一阶腰带材料},
    {name: "十二阶腰带材料", data: 十二阶腰带材料},
    {name: "十三阶腰带材料", data: 十三阶腰带材料}
];
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var text = "\t\t\t\t#e腰带材料礼包购买系统#n\r\n\r\n";
        text += "您可以在此处购买各种腰带材料礼包！\r\n\r\n";
       //text += "提示：每个腰带材料的每个等级礼包只能购买一次，购买完当前等级才能解锁下一等级！\r\n\r\n";
        
        // 用于生成礼包描述的函数
        var getPackageDesc = function(equipIndex, levelIndex) {
            var equipData = 腰带材料列表[equipIndex].data;
        ...
        // 构建腰带材料列表，每行显示两个equip
        for (var i = 0; i < 腰带材料列表.length; i += 2) {
            var equip1 = 腰带材料列表[i];
            var equip2 = (i + 1 < 腰带材料列表.length) ? 腰带材料列表[i + 1] : null;
            
            // 获取equip1的购买进度
            var progressKey1 = "腰带材料礼包购买进度_" + i;
            ...
            //equip2行（如果存在）
            if (equip2) {
                var progressKey2 = "腰带材料礼包购买进度_" + (i + 1);
        ...
        var equipData = 腰带材料列表[selectedequip];
        ...
        // 获取该equip的购买进度
        var progressKey = "腰带材料礼包购买进度_" + selectedequip;
