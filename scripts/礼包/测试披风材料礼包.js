// 披风材料数据 - 每个数组第一个元素是材料ID，后面材料数量
var 一阶披风材料 = [4443300, 5, 8, 15, 31, 54]
var 二阶披风材料 = [4500802, 4, 8, 13, 28, 49]
var 三阶披风材料 = [4500803, 4, 7, 12, 26, 44]
var 四阶披风材料 = [4500804, 3, 6, 11, 24, 40]
var 五阶披风材料 = [4500805, 3, 6, 10, 21, 37]
var 六阶披风材料 = [4500806, 3, 5, 9, 19, 33]
var 七阶披风材料 = [4500807, 3, 5, 8, 18, 30]
var 八阶披风材料 = [4500808, 2, 4, 8, 16, 28]
var 九阶披风材料 = [4500809, 2, 4, 7, 15, 25]
var 十阶披风材料 = [4500810, 2, 4, 6, 13, 23]
var 十一阶披风材料 = [4500811, 2, 3, 6, 12, 21]
var 十二阶披风材料 = [4500812, 2, 3, 5, 11, 19]
var 十三阶披风材料 = [4500813, 1, 3, 5, 10, 17]

// 将所有披风材料数据组织成一个数组
var 披风材料列表 = [
    {name: "一阶披风材料", data: 一阶披风材料},
    {name: "二阶披风材料", data: 二阶披风材料},
    {name: "三阶披风材料", data: 三阶披风材料},
    {name: "四阶披风材料", data: 四阶披风材料},
    {name: "五阶披风材料", data: 五阶披风材料},
    {name: "六阶披风材料", data: 六阶披风材料},
    {name: "七阶披风材料", data: 七阶披风材料},
    {name: "八阶披风材料", data: 八阶披风材料},
    {name: "九阶披风材料", data: 九阶披风材料},
    {name: "十阶披风材料", data: 十阶披风材料},
    {name: "十一阶披风材料", data: 十一阶披风材料},
    {name: "十二阶披风材料", data: 十二阶披风材料},
    {name: "十三阶披风材料", data: 十三阶披风材料}
];
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var text = "\t\t\t\t#e披风材料礼包购买系统#n\r\n\r\n";
        text += "您可以在此处购买各种披风材料礼包！\r\n\r\n";
       //text += "提示：每个披风材料的每个等级礼包只能购买一次，购买完当前等级才能解锁下一等级！\r\n\r\n";
        
        // 用于生成礼包描述的函数
        var getPackageDesc = function(equipIndex, levelIndex) {
            var equipData = 披风材料列表[equipIndex].data;
        ...
        // 构建披风材料列表，每行显示两个equip
        for (var i = 0; i < 披风材料列表.length; i += 2) {
            var equip1 = 披风材料列表[i];
            var equip2 = (i + 1 < 披风材料列表.length) ? 披风材料列表[i + 1] : null;
            
            // 获取equip1的购买进度
            var progressKey1 = "披风材料礼包购买进度_" + i;
            ...
            //equip2行（如果存在）
            if (equip2) {
                var progressKey2 = "披风材料礼包购买进度_" + (i + 1);
        ...
        var equipData = 披风材料列表[selectedequip];
        ...
        // 获取该equip的购买进度
        var progressKey = "披风材料礼包购买进度_" + selectedequip;
