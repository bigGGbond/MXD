// 武器材料数据 - 每个数组第一个元素是材料ID，后面材料数量
var 一阶武器材料 = [4033104, 21, 38, 69, 148, 262];
var 二阶武器材料 = [4500202, 19, 34, 62, 135, 238];
var 三阶武器材料 = [4500203, 17, 31, 57, 123, 216];
var 四阶武器材料 = [4500204, 16, 28, 52, 112, 197];
var 五阶武器材料 = [4500205, 14, 26, 47, 101, 179];
var 六阶武器材料 = [4500206, 13, 24, 43, 92, 162];
var 七阶武器材料 = [4500207, 12, 21, 39, 84, 148];
var 八阶武器材料 = [4500208, 11, 19, 35, 76, 134];
var 九阶武器材料 = [4500209, 10, 18, 32, 69, 122];
var 十阶武器材料 = [4500210, 9, 16, 29, 63, 111];
var 十一阶武器材料 = [4500211, 8, 15, 27, 57, 101];
var 十二阶武器材料 = [4500212, 7, 13, 24, 52, 92];
var 十三阶武器材料 = [4500213, 7, 12, 22, 47, 83];


// 将所有武器材料数据组织成一个数组
var 武器材料列表 = [
    {name: "一阶武器材料", data: 一阶武器材料},
    {name: "二阶武器材料", data: 二阶武器材料},
    {name: "三阶武器材料", data: 三阶武器材料},
    {name: "四阶武器材料", data: 四阶武器材料},
    {name: "五阶武器材料", data: 五阶武器材料},
    {name: "六阶武器材料", data: 六阶武器材料},
    {name: "七阶武器材料", data: 七阶武器材料},
    {name: "八阶武器材料", data: 八阶武器材料},
    {name: "九阶武器材料", data: 九阶武器材料},
    {name: "十阶武器材料", data: 十阶武器材料},
    {name: "十一阶武器材料", data: 十一阶武器材料},
    {name: "十二阶武器材料", data: 十二阶武器材料},
    {name: "十三阶武器材料", data: 十三阶武器材料}
];
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var text = "\t\t\t\t#e武器材料礼包购买系统#n\r\n\r\n";
        text += "您可以在此处购买各种武器材料礼包！\r\n\r\n";
       //text += "提示：每个武器材料的每个等级礼包只能购买一次，购买完当前等级才能解锁下一等级！\r\n\r\n";
        
        // 用于生成礼包描述的函数
        var getPackageDesc = function(equipIndex, levelIndex) {
            var equipData = 武器材料列表[equipIndex].data;
        ...
        // 构建武器材料列表，每行显示两个equip
        for (var i = 0; i < 武器材料列表.length; i += 2) {
            var equip1 = 武器材料列表[i];
            var equip2 = (i + 1 < 武器材料列表.length) ? 武器材料列表[i + 1] : null;
            
            // 获取equip1的购买进度
            var progressKey1 = "武器材料礼包购买进度_" + i;
            ...
            //equip2行（如果存在）
            if (equip2) {
                var progressKey2 = "武器材料礼包购买进度_" + (i + 1);
        ...
        var equipData = 武器材料列表[selectedequip];
        ...
        // 获取该equip的购买进度
        var progressKey = "武器材料礼包购买进度_" + selectedequip;
