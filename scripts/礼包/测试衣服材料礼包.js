// 衣服材料数据 - 每个数组第一个元素是材料ID，后面材料数量
var 一阶衣服材料 = [4033232, 21, 38, 69, 148, 262];
var 二阶衣服材料 = [4500102, 19, 34, 62, 135, 238];
var 三阶衣服材料 = [4500103, 17, 31, 57, 123, 216];
var 四阶衣服材料 = [4500104, 16, 28, 52, 112, 197];
var 五阶衣服材料 = [4500105, 14, 26, 47, 101, 179];
var 六阶衣服材料 = [4500106, 13, 24, 43, 92, 162];
var 七阶衣服材料 = [4500107, 12, 21, 39, 84, 148];
var 八阶衣服材料 = [4500108, 11, 19, 35, 76, 134];
var 九阶衣服材料 = [4500109, 10, 18, 32, 69, 122];
var 十阶衣服材料 = [4500110, 9, 16, 29, 63, 111];
var 十一阶衣服材料 = [4500111, 8, 15, 27, 57, 101];
var 十二阶衣服材料 = [4500112, 7, 13, 24, 52, 92];
var 十三阶衣服材料 = [4500113, 7, 12, 22, 47, 83];


// 将所有衣服材料数据组织成一个数组
var 衣服材料列表 = [
    {name: "一阶衣服材料", data: 一阶衣服材料},
    {name: "二阶衣服材料", data: 二阶衣服材料},
    {name: "三阶衣服材料", data: 三阶衣服材料},
    {name: "四阶衣服材料", data: 四阶衣服材料},
    {name: "五阶衣服材料", data: 五阶衣服材料},
    {name: "六阶衣服材料", data: 六阶衣服材料},
    {name: "七阶衣服材料", data: 七阶衣服材料},
    {name: "八阶衣服材料", data: 八阶衣服材料},
    {name: "九阶衣服材料", data: 九阶衣服材料},
    {name: "十阶衣服材料", data: 十阶衣服材料},
    {name: "十一阶衣服材料", data: 十一阶衣服材料},
    {name: "十二阶衣服材料", data: 十二阶衣服材料},
    {name: "十三阶衣服材料", data: 十三阶衣服材料}
];
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var text = "\t\t\t\t#e衣服材料礼包购买系统#n\r\n\r\n";
        text += "您可以在此处购买各种衣服材料礼包！\r\n\r\n";
       //text += "提示：每个衣服材料的每个等级礼包只能购买一次，购买完当前等级才能解锁下一等级！\r\n\r\n";
        
        // 用于生成礼包描述的函数
        var getPackageDesc = function(equipIndex, levelIndex) {
            var equipData = 衣服材料列表[equipIndex].data;
        ...
        // 构建衣服材料列表，每行显示两个equip
        for (var i = 0; i < 衣服材料列表.length; i += 2) {
            var equip1 = 衣服材料列表[i];
            var equip2 = (i + 1 < 衣服材料列表.length) ? 衣服材料列表[i + 1] : null;
            
            // 获取equip1的购买进度
            var progressKey1 = "衣服材料礼包购买进度_" + i;
            ...
            //equip2行（如果存在）
            if (equip2) {
                var progressKey2 = "衣服材料礼包购买进度_" + (i + 1);
        ...
        var equipData = 衣服材料列表[selectedequip];
        ...
        // 获取该equip的购买进度
        var progressKey = "衣服材料礼包购买进度_" + selectedequip;
