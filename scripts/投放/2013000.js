...
function action(mode, type, selection) {
	...
	if (mode == -1) {
		...
		if (status == 0) {
			...
			cm.dispose();
			cm.openNpc(9900001, "副本1");
		}else if (selection == 2) {
			cm.dispose();
			cm.openNpc(9900001, "副本2");
		}else if (selection == 3) {
			cm.dispose();
			cm.openNpc(9900001, "副本3");
		}else if (selection == 4) {
			cm.dispose();
			cm.openNpc(9900001, "副本4");
		} else if (selection == 5) {	
			cm.dispose();
			cm.openNpc(9900001, "副本5");
		} else if (selection == 6) {
			cm.dispose();
			cm.openNpc(9900001, "嘉年华");
		} else if (selection == 7) {
			cm.dispose();
			cm.openNpc(9900001, "武陵");
		}
	}
}
