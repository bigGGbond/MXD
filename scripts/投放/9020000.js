...
function action(mode, type, selection) {
	...
	if (mode == -1) {
		...
		if (status == 0) {
            ...
            text += "                \t#r#L5#日常礼包#l   \r\n\r\n";
			text += "\r\n\r\n"
			text += "#r  " + 美化4 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化5 + "#l#k\r\n";
			cm.sendSimpleS(text, 2);
		} else if (selection == 1) {
			cm.dispose();
			cm.openNpc(9900001, "元宝礼包");
		}else if (selection == 2) {
			cm.dispose();
			cm.openNpc(9900001, "至尊会员");
		}else if (selection == 3) {
			cm.dispose();
			cm.openNpc(9900001, "月卡");
		}else if (selection == 4) {
			cm.dispose();
			cm.openNpc(9900001, "战令");
		} else if (selection == 5) {
			cm.dispose();
			cm.openNpc(9900001, "日常礼包");
		}
	}
}
