...
function setup(eim, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("boss8");
    var map = eim.setInstanceMap(910033305);//刷新地图
    eim.setProperty("boss8Summoned", "0");
    ...
    map.setRankName("boss8");//设置boss名称
...
function gainchrdamage(eim, string) {
    var map = eim.getMapFactory().getMap(910033305);
...
function end(eim) {
    eim.disposeIfPlayerBelow(100, 910033305);//死了出去的地图
    em.setProperty("state", "0");
    em.setProperty("leader", "true");
    em.setProperty("boss8Summoned", "0");
}
...
function allMonstersDead(eim) {
    ...
    gainchrdamage(eim, 'boss8');  // 更新BOSS标识
