...
def process_excel():
    # 打开Excel文件
    wb = openpyxl.load_workbook(r'C:\Users\李柱柱\Desktop\sc\scripts\材料新\excel\耳环.xlsx')
    ws = wb['Sheet1']

    # 初始化数据结构
    data = {}
    current_earring_id = None
    ...
    for row_idx, row in enumerate(ws.iter_rows(values_only=True)):
        ...
        try:
            ...
            # 添加到数据结构
            data[earring_id][f"等级{level}"] = level_data
...
def save_json(data, filename='耳环进阶数据.json'):
    """保存为JSON文件"""
