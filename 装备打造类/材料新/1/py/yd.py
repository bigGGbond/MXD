...
def process_excel():
    # 打开Excel文件
    wb = openpyxl.load_workbook(r'C:\Users\Admin\Desktop\sc\scripts\材料新\excel\腰带.xlsx')
    ws = wb['Sheet1']
    ...
    for row_idx, row in enumerate(ws.iter_rows(values_only=True)):
        ...
        material1 = {
            ...
            'bind': null_if_none(row[8]),                  # 材料1无绑定
        ...
        # 添加到数据结构
        data[belt_id][f"等级{level}"] = level_data

    return data

def save_json(data, filename='腰带进阶数据.json'):
    """保存为JSON文件"""
